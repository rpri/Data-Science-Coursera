...
predictor.model<-function(model,method){
  switch(method,
         backoff=function(w1,w2,w3) predict.backoff(model,w1,w2,w3),
         interp=function(w1,w2,w3) predict.interp(model,w1,w2,w3),
         interp.ex=function(w1,w2,w3) predict.interp.ex(model,w1,w2,w3),
         pr=function(w1,w2,w3) getpr(model,w1,w2,w3),
         pr.ext=function(w1,w2,w3) get.pr.ext(model,w1,w2,w3))
        
}

predict.backoff <- function(model,x1,x2,x3){
